          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Connect and sync with Google Calendar (needs API keys)</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
              <div className="w-2 h-2 rounded-full bg-orange-500 mt-2 flex-shrink-0" />
              <div>
                ...
                <p className="text-sm text-muted-foreground">Placeholder for Apple Calendar sync (needs server implementation)</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-muted/50 rounded-lg">
              <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0" />
              <div>
                ...
                <p className="text-sm text-muted-foreground">Click on calendar to create new tasks</p>
              </div>
            </div>
          </div>
        </Card>
