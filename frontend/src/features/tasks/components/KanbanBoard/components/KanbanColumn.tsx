    ...
    >
      ...
      <div className={cn(
        ...
        {tasks.length === 0 ? (
          <button
            type="button"
            className="flex flex-col h-full items-center justify-start py-12 text-center cursor-pointer opacity-50 hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 transition-opacity rounded-xl"
            onClick={() =>
              openDialog({ initialData: { status }, viewMode: "create" })
            }
            aria-label={`Add task to ${title}`}
